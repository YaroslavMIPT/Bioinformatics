...
#SBATCH --partition=AMD9554-common     # Указана доступная очередь
...
/home/STUDY/FBMF/bioinformatics/soft/velvet/velvetg $OUT_DIR/k31 -ins_length 300



# k-mer 41

/home/STUDY/FBMF/bioinformatics/soft/velvet/velveth $OUT_DIR/k41 41 -fastq -shortPaired $FASTQ1 $FASTQ2

/home/STUDY/FBMF/bioinformatics/soft/velvet/velvetg $OUT_DIR/k41 -ins_length 300



# k-mer 51

/home/STUDY/FBMF/bioinformatics/soft/velvet/velveth $OUT_DIR/k51 51 -fastq -shortPaired $FASTQ1 $FASTQ2

/home/STUDY/FBMF/bioinformatics/soft/velvet/velvetg $OUT_DIR/k51 -ins_length 300
